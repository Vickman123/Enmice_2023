...
const people = [
    {
      name: 'Ing. Ramón Omar Córdova Muñoz',
      role: 'Director General de ENMICE. Director General y de Tecnología en BID360 Aeroespacial',
      imageUrl:
        'https://haciaelespacio.aem.gob.mx/mexicohacialaluna/images/ponentes/RamonOmarCordovaMun%CC%83oz.jpg',
    ...
    {
        name: 'Carlos Felipe Ávila Gómez',
        role: 'Director de Operaciones y Estrategia de ENMICE', 
        
        imageUrl:
          'https://yt3.googleusercontent.com/ytc/AL5GRJXXRTrAGD8qOtyc_Ii06yE5n-ud8DUNiI-osOeXx2g=s900-c-k-c0x00ffffff-no-rj',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
    
    {
        name: 'Walter Adrián Ahrens Castro',
    ...
    {
        name: 'Mtro. Ariel Hiram Gómez López',
        role: 'Big Data Engineer at Tiger Analytics Monterrey, Nuevo León, México',
        imageUrl:
          'https://media.licdn.com/dms/image/C4E22AQHQmx7YrVC8iQ/feedshare-shrink_800/0/1672745234945?e=2147483647&v=beta&t=kcq2obLpc2HtOB7dS87VurN4RcF--8w3IokH7Q4kWto',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
        ...
        <div className="mx-auto lg:mx-12 max-w-full py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-12">
            <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Equipo ENMICE</h2>
